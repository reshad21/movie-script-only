...
const SugestedShow = (props) => {
    const { props: SugestedMovies } = props;
    ...
    return (
        <div className='mb-4 relative w-full'>
            <div className="title flex items-center gap-1 align-middle">
                <h1 className='my-4 text-2xl inline-block rounded p-2 text-slate-200'>{SugestedMovies}</h1>
            ...
            >
                {
                    similar?.map(item => <SwiperSlide><SuggestedItem item={item} key={item?.id}></SuggestedItem></SwiperSlide>)
                }
            </Swiper>

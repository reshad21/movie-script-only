        ...
        <div>
            <div className="shadow-xl border-2 rounded-[6px] border-slate-700 overflow-hidden">
                <div className='relative'>
                    ...
                    <Link to={`/movie/${toprated?.id}/movie-${toprated?.title.replace(/\s/g, '-')}`}>
            ...
            <p className='pl-2 pt-1 dark:font-extralight text-[14px] text-slate-200'>{toprated?.original_title}</p>
        </div>
    );
};
